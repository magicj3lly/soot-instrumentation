...
public class Scene // extends AbstractHost
{
  ...
  public static boolean isApk(String file) {
    System.out.println("Scene::isApk-----------------------");
    ...
    if (apkFilter.accept(apk)) {
        System.out.println("This is an apk file");
	return true;
    }
    if (!apkFilter.accept(apk)) {
	    System.out.println("not an apkfile");
      return r;
    }
  ...
  public void loadNecessaryClasses() {
    ...
    if (Options.v().oaat()) {
      ...
      for (final String path : Options.v().process_dir()) {
        System.out.println("Scene.java::path---> " + path);
        for (String cl : SourceLocator.v().getClassesUnder(path)) {
          System.out.println("Scene.java::class---> " + cl);
